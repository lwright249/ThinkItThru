...
myTaskList.addTask(new Task("task one", 200, priority.HIGH, 15, new Date(2024, 3, 5)));
myTaskList.addTask(new Task("task two", 200, priority.MED, 15, new Date(2024, 3, 6)));
myTaskList.addTask(new Task("task three", 200, priority.LOW, 15, new Date(2024, 3, 4)));
//its not adding this one for some reason?
myTaskList.addTask(new Task("task four", 200, priority.HIGH, 15, new Date(2024, 3, 6)));
myTaskList.addTask(new Task("task five", 200, priority.HIGH, 15, new Date(2024, 3, 3)));
myTaskList.logTasks();
console.log("done");
